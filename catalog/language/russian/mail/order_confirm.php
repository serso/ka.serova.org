...
$_['text_greeting']         = 'Благодарим за интерес к нашим товарам %s. Как только заказ будет обработан мы свяжемся с Вами.';
...
$_['text_invoice']          = 'Для просмотра Вашего заказа, щелкните:';
