...
$_['entry_description']       = 'Сообщение приветствия:';
...
$_['entry_mail_protocol']     = 'Протокол почты:';
$_['entry_mail_parameter']    = 'Параметры почты:<span class="help">Когда используется \'Mail\', дополнительные параметры почты могут быть указаны тут (напр. "-femail@storeaddress.com".';
