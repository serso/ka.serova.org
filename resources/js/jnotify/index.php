...
<body>
<p>
<a href="index.php#" class="success">It's a success !</a><br />
<a href="index.php#" class="notice">It's a notice !</a><br />
<a href="index.php#" class="error">It's an error !</a><br /><br />
<a href="index.php#" class="three">Success, Notify and Error !!</a><br />
